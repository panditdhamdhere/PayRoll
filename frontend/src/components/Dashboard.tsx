  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 relative z-10">
        <motion.h1 layout className="text-3xl md:text-4xl font-bold mb-2 text-black dark:text-white">
          Dashboard
        </motion.h1>
        <motion.p layout className="text-black dark:text-gray-300">
      ...
      <div className="relative rounded-2xl border border-white/10 dark:border-white/5 bg-white/75 dark:bg-gray-900/70 backdrop-blur-xl">
